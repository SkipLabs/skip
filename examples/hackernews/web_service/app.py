...
SKIP_WRITE_URL = "http://skip_leader:8081/v1" if 'DISTRIBUTED_MODE' in os.environ else "http://reactive_service:8081/v1"
SKIP_READ_URL = "http://skip_followers:8081/v1" if 'DISTRIBUTED_MODE' in os.environ else "http://reactive_service:8081/v1"
