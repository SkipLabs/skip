...
async function promptDB() {
  ...
  //  await skdb.server.mirror("user_profiles");
  //  await skdb.server.mirror("whitelist_skiplabs_employees");
  //  await skdb.server.mirror("posts");
  //  await skdb.server.mirror("all_access");
