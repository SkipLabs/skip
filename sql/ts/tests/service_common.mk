...
$(SDKMAN_DIR)/candidates/java/20.0.2-tem: $(SDKMAN_DIR)
	@mkdir -p $(BUILD_DIR)
	@source $(SDKMAN_INIT) && sdk install java 20.0.2-tem 1>&2 > $(BUILD_DIR)/install_java.log

$(SDKMAN_DIR)/candidates/gradle: $(SDKMAN_DIR)/candidates/java/20.0.2-tem
	@source $(SDKMAN_INIT) && sdk install gradle 8.3 1>&2 > $(BUILD_DIR)/install_gradle.log
