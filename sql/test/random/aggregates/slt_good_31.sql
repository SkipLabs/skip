...
SELECT DISTINCT - ( - + 51 ) - 78 * + SUM ( col0 ) FROM tab0 WHERE col0 > NULL
;
...
SELECT ( - SUM ( + ( col1 ) ) ) AS col0 FROM tab2 WHERE ( 15 ) IS NULL
;
...
SELECT ALL SUM ( - col2 ) * + 37 AS col1 FROM tab2 AS cor0 WHERE NOT ( NULL ) IS NULL
;
...
SELECT + 47 + - SUM ( DISTINCT + + col0 ) FROM tab0 WHERE NOT ( NOT ( NULL ) IS NOT NULL )
;
...
SELECT ALL - SUM ( ALL + + 13 ) FROM tab1 AS cor0 WHERE NOT NULL <> NULL
;
...
SELECT + SUM ( DISTINCT - col0 ) FROM tab0 WHERE NOT ( NULL ) IS NULL
;
...
SELECT DISTINCT - SUM ( DISTINCT - col1 ) AS col1 FROM tab0 AS cor0 WHERE NOT col2 / - col1 <> NULL
;
...
SELECT + ( + SUM ( - - 8 ) ) + - 61 - - + 68 AS col2 FROM tab1 AS cor0 WHERE NULL NOT BETWEEN NULL AND col0 + + 52
;
...
SELECT * FROM tab0 AS cor0 JOIN tab0 AS cor1 ON NOT NULL > NULL
...
SELECT ALL + + SUM ( ALL - 33 ) FROM tab0 WHERE NOT + - 96 IS NOT NULL
;
...
SELECT ALL SUM ( 83 ) FROM tab1 AS cor0 WHERE NOT - col1 NOT IN ( + + col0 * 24 )
;
...
SELECT DISTINCT SUM ( ALL + col0 ) FROM tab1 AS cor0 WHERE NULL > + col0
;
...
SELECT SUM ( ALL - 1 ) FROM tab1 AS cor0 WHERE NOT NULL <> NULL
;
...
SELECT ALL SUM ( - 67 ) FROM tab1 AS cor0 WHERE ( NULL ) IN ( + col0 * col0 / + ( + + 20 ) )
;
...
SELECT ALL - SUM ( col1 ) AS col2 FROM tab0 cor0 WHERE ( NULL ) BETWEEN col1 + - col2 * - + col1 + - + col1 AND + col1 * + 6
;
...
SELECT + + SUM ( - col2 ) AS col0 FROM tab1 WHERE NOT - col2 >= NULL
;
...
SELECT + + 50, SUM ( DISTINCT col2 ) AS col0 FROM tab0 WHERE NOT col2 <> NULL
;
...
SELECT ALL - - SUM ( ALL + + col2 ) AS col0 FROM tab1 AS cor0 WHERE - col1 IS NULL
;
