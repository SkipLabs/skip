...
build/a.out: build/out.ll build/runtime.bc
	...
	wasm-ld-10 --initial-memory=67108864 -export=getCompositeName -export=getCompositeSize -export=getCompositeAt -export=getStringSize -export=getLeafValue -export=objectKind -export=sk.call0 -export=mymemcpy -export=malloc -export=skip_main -export=SKIP_initializeSkip build/out.o -o build/out.wasm --no-entry -allow-undefined
